...
const I18N = {
  fr: {
    ...
    dj1_role: 'Tête d’affiche',
    dj1_bio: "Descriptif de l'artiste — parcours, style, sets marquants. Deux ou trois phrases suffisent.",
    dj2_role: 'Invité·e',
    dj2_bio: "Descriptif de l'artiste — parcours, style, sets marquants. Deux ou trois phrases suffisent.",
    listen: 'À écouter',
  ...
  en: {
    ...
    dj1_role: 'Headliner',
    dj1_bio: 'Artist description — background, style, standout sets. Two or three sentences is plenty.',
    dj2_role: 'Guest',
    dj2_bio: 'Artist description — background, style, standout sets. Two or three sentences is plenty.',
    listen: 'Listen',
